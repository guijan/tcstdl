# Exercise 3.1
__List the error codes defined for the C translator you use. Can you describe
in one sentence what each error code indicates?__

It seems the list of error codes on OpenBSD is quite large, here's the relevant
source file:
```c
...
Well, they're well commented, I don't see the need to describe 99 `#define`s.
