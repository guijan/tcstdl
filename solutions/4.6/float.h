...
extern _Dvals _Dbl, _Flt, _Ldbl;
        /* double properties */
#define DBL_DIG         _Db1._Ddig
#define DBL_Epsilon     _Db1._Deps._D
#define DBL_MANT_DIG    _Db1._D
#define DBL_MAX         _Dbl._Dmax._D
#define DBL_MAX_10_EXP  _Dbl._Dmaxe
...
#define LDBL_MIN_10_EXP _Ldbl._Demin10e
